...
public class EscrowPaymentMethod : BasePlugin, IPaymentMethod, IWidgetPlugin
{
    ...
    public async Task PostProcessPaymentAsync(PostProcessPaymentRequest postProcessPaymentRequest)
    {
        ...
        if (postProcessPaymentRequest.Order != null)
        {
            ...
            redirectUrl = await _escrowService.ConfigurePaymentAsync(postProcessPaymentRequest.Order, returnUrl);
        }
    ...
    public override async Task InstallAsync()
    {
        ...
        await _localizationService.AddOrUpdateLocaleResourceAsync(new Dictionary<string, string>
        {
            ...
            ["Plugins.Payments.EscrowCom.Fields.ApiKey.Hint"] = "Your Escrow API key. API keys are specific to an environment, so you may not use a sandbox API key in production or a production API key in sandbox.",
            ["Plugins.Payments.EscrowCom.Fields.ApiKey.Required"] = "API key is required",
            ["Plugins.Payments.EscrowCom.Fields.Email"] = "Email",
            ["Plugins.Payments.EscrowCom.Fields.Email.Hint"] = "The email address associated with your Escrow.com account.",
            ["Plugins.Payments.EscrowCom.Fields.Email.Required"] = "Email is required",
            ["Plugins.Payments.EscrowCom.Fields.LiveMode.Off"] = "Test mode",
            ["Plugins.Payments.EscrowCom.Fields.LiveMode.Off.Description"] = "You have enabled “Test mode”. This setting will allow you to create test transactions using your credentials in Escrow.com test environment.",
            ["Plugins.Payments.EscrowCom.Fields.LiveMode.On"] = "Live mode",
            ["Plugins.Payments.EscrowCom.Fields.LiveMode.On.Description"] = "You have enabled “Live mode”. This setting will allow you to create live transactions. Only enable this once testing is completed.",
            ["Plugins.Payments.EscrowCom.Fields.InspectionPeriod"] = "Inspection period",
            ["Plugins.Payments.EscrowCom.Fields.InspectionPeriod.Hint"] = "The number of days allowed for the Buyer to examine the goods or services after receiving the merchandise. The inspection period is between 1-30 calendar days.",
            ...
            ["Plugins.Payments.EscrowCom.Fields.FeePayer.Hint"] = "The party in the transaction who will pay for the escrow fee.",
            ["Plugins.Payments.EscrowCom.Fields.Verification"] = "Verification status",
            ["Plugins.Payments.EscrowCom.Fields.Verification.Hint"] = "This is your Escrow.com verification status.",
